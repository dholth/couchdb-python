...
# loaded by couchdbkit with _attachments and couchapp keys removed:
expected = {
...
class LoaderTestCase(unittest.TestCase):
    ...
    def test_loader(self):
        ...
        doc = loader.load_design_docs(directory, strip_files=True)
        self.assertTrue(doc == expected, (doc, expected))
